...
def config_from_atoms_list(
    ...
    dipole_deriv_key="REF_dipole_deriv",
    charges_key="REF_charges",
    polarizability_key="REF_polarizability",
    polarizability_deriv_key="REF_polarizability_deriv",
    head_key="head",
...
def load_from_xyz(
    ...
    dipole_deriv_key: str = "REF_dipole_deriv",
    charges_key: str = "REF_charges",
    polarizability_key: str = "REF_polarizability",
    polarizability_deriv_key: str = "REF_polarizability_deriv",
    head_key: str = "head",
